...
Nguyên	Cập nhật thông tin tài khoản, theo dõi lịch sử số dư
Quang	Xử lý các chức năng liên quan đến ví (nạp, chuyển, nhận điểm, ghi nhận giao dịch)
Hoàn	Phát triển chức năng lưu backup dữ liệu
...
Client: Khi tạo mới, người dùng tự đặt mật khẩu (role: client).
